...
namespace ConsoleApplication
{
    ...
    {
        public static string Print(this Tuple<double, double, double> tuple, bool dataOnly)
        {
            var convertedBytes = ConvertBytes(tuple.Item2);
            var convertedRate = ConvertBytes(tuple.Item3);
            if (dataOnly)
            {
